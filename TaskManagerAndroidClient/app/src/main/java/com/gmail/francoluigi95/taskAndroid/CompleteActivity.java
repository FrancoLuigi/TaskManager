...
public class CompleteActivity extends AppCompatActivity {
    ...
    public class CompleteRestTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String res) {
            ...
            if (res != null) {
                ...
                Toast.makeText(getApplicationContext(), "Il task è stato completato", Toast.LENGTH_SHORT).show();
                textOUT.setText(res);
            }
        }
    }
