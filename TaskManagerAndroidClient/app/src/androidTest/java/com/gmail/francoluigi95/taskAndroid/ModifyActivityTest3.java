...
public class ModifyActivityTest3 {

    // test per la modifica di un task, viene inserito solo il testo
        ...
        ViewInteraction appCompatEditText1 = onView(
                allOf(withId(R.id.text),
                        childAtPosition(
                                ...
                                3),
                        isDisplayed()));
        appCompatEditText1.perform(replaceText("aa"), closeSoftKeyboard());
