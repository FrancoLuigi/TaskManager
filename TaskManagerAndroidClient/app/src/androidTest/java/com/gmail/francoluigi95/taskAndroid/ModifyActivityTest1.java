...
public class ModifyActivityTest1 {

    // test per la modifica di un task, titolo errato

    @Rule
    public ActivityTestRule<LogInActivity> mActivityTestRule = new ActivityTestRule<>(LogInActivity.class);

    @Test
    public void modifyActivityTest1() {
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.title),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText4.perform(replaceText("qqq"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText7 = onView(
                allOf(withId(R.id.data), withText("28/12/2018 "),
                        childAtPosition(
                                ...
                                5),
                        isDisplayed()));
        appCompatEditText7.perform(replaceText("29/12/2018 "));

        ViewInteraction appCompatEditText8 = onView(
                allOf(withId(R.id.data), withText("29/12/2018 "),
                        childAtPosition(
                                allOf(withId(R.id.activity_post_note),
                                        childAtPosition(
                                                withId(android.R.id.content),
        ...
        ViewInteraction appCompatAutoCompleteTextView = onView(
                allOf(withId(R.id.autocomplete_title),
                        childAtPosition(
                                ...
                                8),
                        isDisplayed()));
        appCompatAutoCompleteTextView.perform(replaceText("fff"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText10 = onView(
                allOf(withId(R.id.text),
                        childAtPosition(
                                ...
                                3),
                        isDisplayed()));
        appCompatEditText10.perform(replaceText("zz"), closeSoftKeyboard());
        ...
        onView(withId(R.id.task)).check(matches(withText("\"Task modified: null\"")));
    }
