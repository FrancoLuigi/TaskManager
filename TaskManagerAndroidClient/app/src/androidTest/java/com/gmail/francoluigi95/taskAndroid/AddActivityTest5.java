...
public class AddActivityTest5 {

    // Aggiunta di un task il cui titolo è già presente

    @Rule
    public ActivityTestRule<LogInActivity> mActivityTestRule = new ActivityTestRule<>(LogInActivity.class);

    @Test
    public void addActivityTest5() {
        ...
        ViewInteraction appCompatEditText7 = onView(
                allOf(withId(R.id.text),
                        childAtPosition(
                                ...
                                4),
                        isDisplayed()));
        appCompatEditText7.perform(replaceText("aaa"), closeSoftKeyboard());
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.task), withText("Error: 800 - Task duplicate:task"),
                        childAtPosition(
                                allOf(withId(R.id.activity_post_note),
                                        childAtPosition(
                                                withId(android.R.id.content),
                                ...
                                6),
                        isDisplayed()));
        textView.check(matches(withText("Error: 800 - Task duplicate:task")));
    }
